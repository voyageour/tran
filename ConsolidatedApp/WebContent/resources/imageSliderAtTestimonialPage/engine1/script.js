...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"blast",prev:"",next:"",duration:20*100,delay:20*100,width:543,height:389,autoPlay:true,stopOnHover:true,loop:false,bullets:0,caption:false,captionEffect:"slide",controls:false,logo:"engine1/loading.gif",onBeforeStep:function(i,c){return (i+1 + Math.floor((c-1)*Math.random()))},images:0});