(function($){
    ...
    $.fn.extend({ 
        ...
        feedbackTab: function(options) {
 			...
 			//Handy for CSS
			$body = $('body');
			$body.addClass('quickFeedback').append('<div id="feedbackWrapper"><div id="feedbackBox"><a href="#" id="feedbackClose">x</a><ul id="feedbackNav"><li class="live" id="t1"><a href="#"><span></span>General</a></li><li id="t2"><a href="#"><span></span>Suggestion</a></li><li id="t3"><a href="#"><span></span>Problem</a></li><li id="t4"><a href="#"><span></span>Praise</a></li></ul><ul id="feedbackForms"><li class="currentForm"><form><div class="personalDetails"></div><label class="l3">Feedback</label><textarea title="Feedback goes here..."></textarea><button>Submit</button></form></li><li><form><div class="personalDetails"></div><label class="l3">Suggestion</label><textarea title="Suggestions go here..."></textarea><button>Submit</button></form></li><li><form><div class="personalDetails"></div><label class="l3">Problem</label><textarea title="Problems go here..."></textarea><button>Submit</button></form></li><li><form><div class="personalDetails"></div><label class="l3">Problem</label><textarea title="Problems go here..."></textarea><button>Submit</button></form></li></ul></div></div>').append('<div id="feedbackTab"><a href="#" id="feedbackTabLink">Feedback</a></div>');
            ...
            var defaults = {
				...
				tab2FieldName: 'feedback_field',
				tab3FieldName: 'feedback_field',
				tab4FieldName: 'feedback_field',
