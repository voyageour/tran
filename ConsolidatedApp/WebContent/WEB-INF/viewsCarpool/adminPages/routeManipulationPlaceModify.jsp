...
<%-- 		  								<tr>
		    								<td style="font-weight: bold; padding-top: 30px;">Select Vehicle for Route :</td>
		    								<td style="padding-top: 30px;">
		        								<select size="1" name="driverVehicleMappingId" > 
													<c:if test="${ listOfDriverVehicleMappingUpdated ne null }">	
												 		<c:forEach var="driverVehicleMapping" items="${listOfDriverVehicleMappingUpdated}">
												 		 	<option value="${ driverVehicleMapping.driverVehicleMappingId }" ${driverVehicleMapping.driverVehicleMappingId == routePlaceData.routeDriverVehicleMappingUpdated.driverVehicleMappingUpdated.driverVehicleMappingId ? 'selected' : ''}>
												 		 		Driver Name: ${ driverVehicleMapping.driver.driverName } , Vehicle Number: ${ driverVehicleMapping.vehicle.vehicleNumber }
												 		 	</option>
												 		</c:forEach> 
												  	</c:if>
				 								</select>
