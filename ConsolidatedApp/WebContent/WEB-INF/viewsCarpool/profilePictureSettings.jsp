	      ...
	      <div class="container">
    		...
    		<div id="templatemo_main">
       			<div id="content" style="width: 90%;">        
					...
					<form:form action="changeProfilePicture.jsp" id="testConfirmUpdateProfilePicture" commandName="user" enctype="multipart/form-data">    
						<div id="wrapper">
							<div id="page">	    
								<div id="container">
									...
									<table width="100%" style="margin: 10px 10px 10px 10px;" border="0">
										<tr>
											<c:choose>
												<c:when test="${ ( fn:contains(user.userProfilePic , 'male.jpg') or fn:contains(user.userProfilePic , 'female.jpg') ) }">
													<td><a href="javascript: void(0)" id="exampleChangePass1" class="myButton" style="background-color:#CACDD0; text-decoration:none;">Delete Profile Picture</a></td>
												</c:when>
												<c:otherwise>
													<td><a href="deleteProfilePicture.jsp" id="exampleChangePass1" class="classname1">Delete Profile Picture</a></td>
												</c:otherwise>
											</c:choose>
									...
									<table width="100%" style="margin: 10px 10px 10px 10px;" border="0">
										...
										<tr>
											<c:choose>
												<c:when test="${not (fn:contains(user.userProfilePic , 'male.jpg') or fn:contains(user.userProfilePic , 'female.jpg') ) }">
													<td>
														<center>
															Your Current Pic is <br><br>
															<img class="image2" height="100px" width="100px" src="${user.userProfilePic}" />
														</center>
													</td>
												</c:when>
												<c:otherwise>
													<td>
														<center>You have not uploaded your profile Pic yet.</center>
													</td>
												</c:otherwise>
											</c:choose>
										</tr>
									...
									<fieldset>   
										...
										<table width="798" style="margin: 10px 10px 10px 10px;" border="0">
											<tr>	
												<td align="left" id="userProfilePicfileTD">
													Upload your picture:
			                    					<input type="file" name="file" id="userProfilePicfile" style="width: 250px;"  class="ui-timepicker-hour"/>
			                    					<br/><br/>
					   				...
					   				<a href="javascript:void(0)" id="example1402" class="myButton">Submit</a>
								</div> 
