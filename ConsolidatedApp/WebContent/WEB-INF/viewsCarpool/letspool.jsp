				...
				<div id="page">	    
					<div id="container">	
						...
						<!-- CARPOOLER START AND END DATE START -->
							<%@include file="../../resources/includes/carpool/letspool/carpoolerDateSelectionOptions.jsp" %>
						<!-- CARPOOLER START AND END DATE END -->
	
						<!-- CARPOOLER START AND END TIMING DETAILS START -->
							<%@include file="../../resources/includes/carpool/letspool/carpoolerSourceToDestinationRouteOption.jsp" %>
						<!-- CARPOOLER START AND END TIMING DETAILS END -->
	   	
						<!-- CARPOOLER RETURN ROUTE DETAILS START -->
							<%@include file="../../resources/includes/carpool/letspool/carpoolerReturnRouteOption.jsp" %>
						<!-- CARPOOLER RETURN ROUTE DETAILS END -->
						 
		    			<!-- CARPOOLER PREFERENCE START -->
							<%@include file="../../resources/includes/carpool/letspool/carpoolerPreference.jsp" %>
						<!-- CARPOOLER PREFERENCE END -->
	
		    			<!-- T&C AGRREMENT START -->
							<%@include file="../../resources/includes/carpool/letspool/termsAndAgreement.jsp" %>
						<!-- T&C AGRREMENT END -->
